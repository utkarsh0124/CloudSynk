...
urlpatterns = [
    ...
    path("login/verify-otp/", views.LoginOTPVerifyAPIView.as_view(), name="verify_login_otp"),
    path("login/resend-otp/", views.ResendLoginOTPAPIView.as_view(), name="resend_login_otp"),
    ...
    path("signup/verify-otp/", views.SignUpOTPVerifyAPIView.as_view(), name="verify_otp"),
    path("signup/resend-otp/", views.ResendSignUpOTPAPIView.as_view(), name="resend_otp"),
