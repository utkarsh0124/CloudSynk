...
print("AZURE_STORAGE_ACCOUNT_NAME:", AZURE_STORAGE_ACCOUNT_NAME)
print("AZURE_STORAGE_ACCOUNT_KEY:", AZURE_STORAGE_ACCOUNT_KEY)
print("AZURE_STORAGE_ENDPOINT_SUFFIX:", AZURE_STORAGE_ENDPOINT_SUFFIX)
